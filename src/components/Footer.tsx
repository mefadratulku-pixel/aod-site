...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-[#000000] text-white pt-16 sm:pt-20 pb-10 select-none">
      <div className="w-full max-w-[1280px] mx-auto px-4 sm:px-8">
        {/* Top Grid matching AOD.svg exact layout */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 pb-14 sm:pb-16 border-b border-white/15">
          {/* Left Column (Brand + WhatsApp) */}
          <div className="lg:col-span-6 space-y-6">
            <div className="font-heading font-black text-4xl sm:text-5xl lg:text-[54px] leading-[1.05] tracking-tight text-[#FF0022] uppercase">
              Fatiqul
              <br />
              Ferdush Asif
            </div>

            <p className="text-[#A0A0A0] text-sm sm:text-base max-w-md font-normal leading-relaxed">
          ...
          <div className="lg:col-span-6 grid grid-cols-2 sm:grid-cols-3 gap-8 pt-2">
            ...
            <div className="space-y-4">
              <span className="font-mono text-xs font-black tracking-widest text-[#FF0022] uppercase block">
                NAVIGATION
              </span>
